...
function Home({ isLoggedIn }) {
  ...
  return (
    <>
<SEO
  title="QuickBills | Home"
  description="Welcome to QuickBills – your all-in-one GST billing solution. Create professional invoices, manage products, and track billing history effortlessly."
